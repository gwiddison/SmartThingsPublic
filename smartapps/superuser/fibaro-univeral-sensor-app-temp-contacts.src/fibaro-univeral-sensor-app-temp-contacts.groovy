 ...
 */
definition(
    name: "Fibaro Univeral Sensor App (Temp + Contacts)",
    namespace: "",
...
preferences {
  section("FUS Module:") {
    	...
    	input "temperature2", "capability.temperatureMeasurement", title: "Second temp probe?", multiple: false, required: false
     	input "temperature3", "capability.temperatureMeasurement", title: "Third temp probe?", multiple: false, required: false
    	input "temperature4", "capability.temperatureMeasurement", title: "Fourth temp probe?", multiple: false, required: false
...
subscribe(fus, "contact1", rsmHandlerContact)
 subscribe(fus, "contact2", rsmHandlerContact)
 /*These are for testing if events not triggering*/
 /*runEvery5Minutes(testhandler("temperature1"))*/
  /*runEvery5Minutes(testhandler("temperature2"))*/
   /*runEvery5Minutes(testhandler("contact1"))*/
