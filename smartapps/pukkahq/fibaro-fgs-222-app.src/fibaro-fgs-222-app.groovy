/**
 *  Dual Relay Adapter (i.e. Enerwave ZWN-RSM2 Adapter, Monoprice Dual Relay, Philio PAN04)Modified for Relay Switch
 *
...
preferences {
  section("ZWN-RSM2 Module:") {
    input "rsm", "capability.relaySwitch", title: "Which RSM2 Module?", multiple: false, required: true
